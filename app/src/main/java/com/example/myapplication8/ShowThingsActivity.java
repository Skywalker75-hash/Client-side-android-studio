...
public class ShowThingsActivity extends AppCompatActivity {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!isLoading && !isLastPage) {
                    ...
                    // 如果总条目数小于或等于最后一个可见条目的位置加1，意味着滚动到了列表底部
    ...
    public class Item {
        ...
        //构造器
        public Item(String name, String imageData, double price,String userName,String Category) {
            this.name = name;
                ...
                try {
                    ...
                    if (data.length() == 0) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            String ItemID=itemObj.getString("ItemID");//获取商品ID

                            // 将解析的数据添加到ArrayList中
                            Item it=new Item(itemName, imageData, price,userName,Category);
                            dataList.add(it);
                        }
                        // 通知适配器数据集已改变，以便更新UI
