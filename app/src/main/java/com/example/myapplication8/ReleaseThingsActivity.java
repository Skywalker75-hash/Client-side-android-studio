...
public class ReleaseThingsActivity extends AppCompatActivity {
   ...
   // private static final String TAG = "UploadTask";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_release_things);
    ...
    private class UploadTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            MultipartBody.Builder builder = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("ItemName", editTextItemName.getText().toString())
                    .addFormDataPart("Category", editTextCategory.getText().toString())
                    .addFormDataPart("Price", editTextPrice.getText().toString());
            ...
            Request request = new Request.Builder()
                    .url("http://10.0.2.2:3000/releaseThings")
                    .post(requestBody)
                    .build();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    Toast.makeText(ReleaseThingsActivity.this, message, Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(ReleaseThingsActivity.this, "响应解析失败", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(ReleaseThingsActivity.this, "上传失败", Toast.LENGTH_SHORT).show();
            }
        }
